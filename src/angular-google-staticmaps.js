        ...
        .controller('StaticGmapCtrl', function () {
            ...
            this.buildSourceString = function buildSourceString(attrs, markers) {
                ...
                var params = Object.keys(attrs).map(function (attr) {
                    if (attr === 'staticmarkers' && markerStrings) {
        ...
        .directive('staticGmap', function ($parse) {
            return {
                ...
                link: function postLink(scope, element, attrs, ctrl) {
                    var el = element[0];
                    var markers = $parse(attrs.staticmarkers)(scope);
                    ...
                    if (typeof(markers.coords) === "string") {
                        scope.$watchCollection(markers.coords, function(newValues) {
                            markers.coords = newValues;
